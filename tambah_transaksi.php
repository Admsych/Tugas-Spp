                                ...
                                <form class="user" action="" method="POST">
                                    ...
                                    <select required name="spp" class="custom-select custom-select-sm form-control form-control-sm"> 
                                        ...
                                        <?php
                                            ...
                                            <option value="<?= $r['id_spp']; ?>"><?= $r['angkatan'] . " | " . $r['nominal']; ?></option>
                                        <?php } ?>          
                                    </select><br><br>
    ...
    if(isset($_POST['simpan'])){
        ...
        if(mysqli_num_rows($cek)>0){
            ...
            if($jumlah>=$ambil['nominal']){
                ...
                $simpan = mysqli_query($db,"INSERT INTO pembayaran(id_pembayaran, id_petugas, NISN, tgl_bayar, id_spp, jumlah_bayar) VALUES ('', '$petugas', '$nama', '".$tanggal."', '$spp', '$jumlah')");
                if($simpan){
                    ?>
                    <meta content="0; url=transaksi.php" http-equiv="refresh"> 
                    <?php
